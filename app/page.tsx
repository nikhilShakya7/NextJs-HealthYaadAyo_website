          ...
          <div className="flex gap-5 w-full max-w-[500px] lg:w-[500px] mx-auto lg:mx-0">
            ...
            <div className="flex flex-col gap-5 flex-1">
              ...
              <div>
                ...
                <p className="text-[#767676] font-['Raleway'] text-[12px] sm:text-[13px] font-normal mt-1 leading-relaxed">
                  Connect with licensed doctors via audio calls, ensuring timely
              ...
              <div>
                ...
                <p className="text-[#767676] font-['Raleway'] text-[12px] sm:text-[13px] font-normal mt-1 leading-relaxed">
                  Access specialized medical expertise from the comfort of your
                  home, Connect with licensed doctors via video calls.
                </p>
              </div>
            </div>
          </div>
