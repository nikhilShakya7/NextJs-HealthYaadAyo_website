    ...
    <>
          ...
          <div className="overflow-hidden relative">
            <ul className="flex gap-4 p-4 animate-scroll whitespace-nowrap">
              ...
              {[1, 2, 3].map((item) => (
                <li
                  key={item}
                  className="relative flex-shrink-0 w-[140px] xs:w-[160px] sm:w-[180px] md:w-[220px] lg:w-[250px] xl:w-[280px]"
                >
                  <img
                  ...
                  />
                  {/* Text Overlay */}
                  <div className="absolute inset-0 flex items-center justify-center text-black font-bold p-2 text-center">
                    {item}
                  </div>
                </li>
              ))}
              ...
              {[1, 2, 3].map((item) => (
                ...
                >
                  ...
                  />
                  {/* Text Overlay */}
                  <div className="absolute inset-0 flex items-center justify-center text-white font-bold p-2 text-center">
      ...
      <div className="flex items-center justify-center h-auto">
        ...
        <div className="w-[1200px]  ">
          ...
          <div className="float-right pt-[120px] relative w-[600px]">
            ...
            <h2 className="-mb-6 font-['Raleway'] text-2xl sm:text-3xl md:text-4xl lg:text-[3rem] xl:text-[3.5rem] leading-tight text-black mt-2 sm:mt-3">
              Delivery At Home
            </h2>
      ...
      <div className="flex items-center justify-center">
        ...
        <div className="w-[1200px] ">
          ...
          <div className="float-left w-[600px] pt-[120px] relative">
            ...
            <p className="-mb-6 pt-8 text-sm xs:text-base sm:text-lg text-[71px] md:text-xl font-normal font-['Raleway'] text-black  md:mb-8 leading-relaxed">
      ...
      <div className="flex items-center justify-center overflow-auto bg-no-repeat bg-right">
        <div className="w-[1200px] relative ">
          <h2 className="-mb-6 text-center text-xl xs:text-2xl sm:text-3xl md:text-4xl lg:text-[1rem] mt-12 xl:text-[2rem] font-normal font-['Raleway'] text-[#34134F] capitalize md:mb-6 leading-tight">
